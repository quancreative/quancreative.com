package com.quancreative.pages.about 
{
	...
	public class AboutPage extends AbstractPage 
	{
		...
		public function AboutPage(aModel : MainModel, aController : MainController = null)
		{
			...
			comingSoon = MovieClip(Library.createAsset(assets, "ComingSoon"));
			addChild(comingSoon);
