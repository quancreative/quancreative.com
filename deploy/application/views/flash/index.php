...
<script src="<?php echo DIR_S . APP_ROOT; ?>/js/swfobject.js" type="text/javascript"></script>
<script src="<?php echo DIR_S . APP_ROOT; ?>/js/swfaddress.js" type="text/javascript"></script>
...
swfobject.embedSWF("<?php echo DIR_S . APP_ROOT; ?>/main.swf", "content", "100%", "100%", "9.0.0", "expressInstall.swf", {}, {bgcolor: '#50341c', menu: 'true', allowfullscreen: 'true'}, {id: 'website'});
</script>
</head>
<body>
	...
	I offer a complete package to all of my clients. I deliver rock solid website creation layered with beautiful design.</p>
        ...
        Or, <a href="<?php echo DIR_S . APP_ROOT; ?>/light/">enter light version (html)</a>
        </p>
